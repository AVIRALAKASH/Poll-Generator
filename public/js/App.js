...
function getChoice(pid) {
  let x = collections.votes[findVote(pid)];
  if (!x || typeof x.vote !== "number") return -1;
  return x.vote;
}
...
const TopBar = function () {
  ...
  class TopBar extends React.Component {
    ...
    render() {
      ...
      return /*#__PURE__*/React.createElement(Base, null, /*#__PURE__*/React.createElement(Title, {
        onClick: () => this.props.gotoPage("home")
      }, "Poll Generator"), $uid && /*#__PURE__*/React.createElement(CurrentUser, {
        href: currentUser.profile,
        onMouseEnter: this.moveIn,
        onMouseLeave: this.moveOn
        ...
        ref: this.tooltip,
        id: "user-tooltip",
        className: "tooltip from-up"
      }, /*#__PURE__*/React.createElement("div", {
        className: "box"
      }, /*#__PURE__*/React.createElement("div", null, currentUser.name), /*#__PURE__*/React.createElement("div", null, currentUser.email), /*#__PURE__*/React.createElement("div", {
        className: "highlight"
...
const Card = function () {
  function User(props) {
    ...
    return /*#__PURE__*/React.createElement(UserName, _extends({
  ...
  function ProgressBar(props) {
    ...
    return /*#__PURE__*/React.createElement(ProgressContainer, {
      title: props.text.join("\n")
    }, /*#__PURE__*/React.createElement(Progress, {
      value: props.value
    }), props.text.map(text => /*#__PURE__*/React.createElement(ProgressText, {
      key: ++i
    }, text)));
  }
  ...
  /* poll */
    ...
    }, /*#__PURE__*/React.createElement(CardHead, null, /*#__PURE__*/React.createElement(User, {
      dark: true,
      isAdmin: creator.isAdmin,
      title: creator.uid,
      onClick: props.selectUid
    }, creator.name)), /*#__PURE__*/React.createElement(CardBody, null, /*#__PURE__*/React.createElement(CardTitle, null, props.title), /*#__PURE__*/React.createElement(CardInfo, null, props.description)), /*#__PURE__*/React.createElement(CardFoot, null, /*#__PURE__*/React.createElement(ProgressBar, {
      value: passed / length,
      text: ended ? ["Ended"] : print
    }), /*#__PURE__*/React.createElement(Button, {
      href: "#",
      className: "icon",
      onClick: props.action
    }, props.className === "overlay" ? googleIcon`close` : hasUserVoted(props.id) ? googleIcon`check` : googleIcon`send`)));
  }
...
const Body = function () {
  ...
  class Body extends React.Component {
    ...
    render() {
      ...
      return /*#__PURE__*/React.createElement(TopBase, null, /*#__PURE__*/React.createElement(Scroll, {
        ref: this.ref,
        onScroll: this.handleScroll
      }, /*#__PURE__*/React.createElement(Flex, {
        className: "body"
      }, (this.props.uid ? [this.props.profile] : []).concat(polls.map(item => /*#__PURE__*/React.createElement(Card, _extends({
        key: item.pid,
        id: item.pid,
        action: () => this.props.selectPid(item.pid),
        selectUid: () => this.props.selectUid(item.user)
      }, item)))))), /*#__PURE__*/React.createElement(Create, {
        onClick: () => this.props.gotoPage("create")
      }, googleIcon`add`));
    }
...
const Overlay = function () {
  ...
  function Overlay(props) {
    ...
    }, /*#__PURE__*/React.createElement(Scroll, null, props.pid && /*#__PURE__*/React.createElement(Flex, {
      className: "overlay"
    }, /*#__PURE__*/React.createElement(Card, _extends({
      id: props.pid,
      className: "overlay",
      action: props.unselectPid
    }, doc)), /*#__PURE__*/React.createElement(Options, null, doc.options.map((option, i) => /*#__PURE__*/React.createElement(Option, {
      key: i,
...
const Create = function () {
  ...
  class Create extends React.Component {
    ...
    render() {
      return /*#__PURE__*/React.createElement(TopBase, null, /*#__PURE__*/React.createElement(Scroll, null, /*#__PURE__*/React.createElement(Flex, null, /*#__PURE__*/React.createElement(Container, null, /*#__PURE__*/React.createElement(Title, null, "Create Poll"), /*#__PURE__*/React.createElement("input", {
        name: "title",
        placeholder: "title",
        ...
        className: "options"
      }, createNOptions(this.state.optionCount, {
        onChange: this.handleChange
      }, this.state), /*#__PURE__*/React.createElement(ControlButtons, null, this.state.optionCount < 10 && /*#__PURE__*/React.createElement("button", {
        className: "material-icons",
        onClick: this.addOption
      }, "add"), this.state.optionCount > 2 && /*#__PURE__*/React.createElement("button", {
        className: "material-icons",
        onClick: this.removeOption
      }, "close"))), /*#__PURE__*/React.createElement("button", {
        onClick: () => createPoll({ ...this.state
        })
      }, "Create")))));
    }
  ...
  function createNOptions(n, props, state) {
    ...
    for (let i = 0; i < n; ++i) {
      result.push( /*#__PURE__*/React.createElement("input", _extends({
        key: i,
        name: "option" + i,
        placeholder: "option"
      }, props, {
        value: state["option" + i]
      })));
    }
...
const Profile = function () {
  ...
  function Profile(props) {
    ...
    const box = /*#__PURE__*/React.createElement(Box, null, /*#__PURE__*/React.createElement("a", {
      href: doc.profile
    }, /*#__PURE__*/React.createElement(Image, {
      src: doc.profile
    })), /*#__PURE__*/React.createElement(Data, null, /*#__PURE__*/React.createElement(TopBar, null, /*#__PURE__*/React.createElement(UserName, {
      dark: true,
      isAdmin: doc.isAdmin
    }, doc.name), /*#__PURE__*/React.createElement(Close, {
      onClick: () => props.gotoPage("home")
    }, googleIcon`close`)), /*#__PURE__*/React.createElement(Email, null, doc.email), /*#__PURE__*/React.createElement(Stats, null, /*#__PURE__*/React.createElement(Element, null, "Polls ", /*#__PURE__*/React.createElement(Number, null, doc.polls.length)), /*#__PURE__*/React.createElement(Element, null, "Votes ", /*#__PURE__*/React.createElement(Number, null, doc.votes.length)))));

    if (props.alone) {
      return /*#__PURE__*/React.createElement(TopBase, null, /*#__PURE__*/React.createElement(Flex, null, box));
    } else {
      return box;
    }
  }
...
const Loading = function () {
  function Loading(props) {
    return /*#__PURE__*/React.createElement(TopBase, {
      className: "loading"
    }, /*#__PURE__*/React.createElement("div", {
      class: "loading-spinner-ripple"
    }, /*#__PURE__*/React.createElement("div", {
      class: "ldrp"
...
class App extends React.Component {
  ...
  render() {
    ...
    if (this.state.isLoading) {
      result = /*#__PURE__*/React.createElement(Loading, null);
    } else {
      switch (this.state.page) {
        case "home":
          result = /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Body, {
            uid: this.state.uid,
            profile: this.state.uid && /*#__PURE__*/React.createElement(Profile, {
              key: this.state.uid,
              alone: false,
              uid: this.state.uid,
            ...
            unselectUid: this.unselectPid,
            gotoPage: this.gotoPage
          }), /*#__PURE__*/React.createElement(Overlay, {
            className: this.state.pid ? "visible" : "",
            pid: this.state.pid,
            unselectPid: this.unselectPid
          }));
          break;

        case "profile":
          result = /*#__PURE__*/React.createElement(Profile, {
            alone: true,
            uid: $uid,
            gotoPage: this.gotoPage
          });
        ...
        case "create":
          result = /*#__PURE__*/React.createElement(Create, null);
          break;
      }
    }
...
async function createPoll({
  ...
  await db.collection("users").doc($uid).update({
    polls: collections.users[uid].polls
  });
  const poll = {
    pid,
    title,
